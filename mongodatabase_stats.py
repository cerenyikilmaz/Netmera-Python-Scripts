...
for db in dbs:
    ...
    if count > 0:
        ...
        for doc in mycol.find({"msgMethod": "CAMPAIGN"}, {"schedule.startDate": 1, "startDate": 1, "_id": 0}).sort("startDate", -1).limit(1):
            ...
            if schedule_start is not None:
                ...
                for doc in mycol2.find({"year": 2021, "month": 12, "day": 20}, {"dailyActDev.TOTAL": 1, "totalDev.TOTAL": 1, "event.n:oa.TOTAL": 1, "_id": 0}):
